...
# --- 4. CSS TỔNG LỰC (ÉP ĐEN & THU NHỎ ĐIỂM SỐ) ---
st.set_page_config(page_title="SmartLens AI Pro", layout="wide")

/* --- THAY THẾ ĐOẠN CSS CŨ BẰNG ĐOẠN NÀY --- */
st.markdown("""
<style>
    /* 1. Nền App & Sidebar đen tuyệt đối */
    [data-testid="stAppViewContainer"], [data-testid="stHeader"], .stApp, [data-testid="stSidebar"] {
        background-color: #0d1117 !important;
        color: #c9d1d9 !important;
    }

    /* 2. ÉP ĐEN Ô NHẬP LIỆU (Tên, Link, Văn bản, Ghi chú) */
    /* Dùng selector mạnh để ghi đè mọi cấu hình mặc định của Streamlit */
    ...
    /* Đảm bảo chữ đang gõ và chữ đã gõ luôn là màu trắng */
    input, textarea {
        color: white !important;
        -webkit-text-fill-color: white !important;
    }

    /* Màu chữ mờ (placeholder) */
    ::placeholder { color: #8b949e !important; opacity: 1; }

    /* 3. Khung Điểm & Lửa (Bé lại như ý bạn) */
    .metric-card {
        background-color: #161b22 !important;
