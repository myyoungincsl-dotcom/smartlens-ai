...
# answered_questions giờ lưu trạng thái: None (chưa nộp), True (đúng), False (sai)
...
# Lấy giá trị tùy chỉnh từ Sidebar (đặt trước để CSS nhận diện)
with st.sidebar:
    ...
    st.markdown(f"""
        <div style="background: #161b22; padding: 20px; border-radius: 20px; border: 1px solid #30363d; text-align: center;">
            ...
            <p class="big-val score-color" style="font-size: 80px !important; font-weight: 900 !important; color: #f2cc60 !important; margin: 0;">{st.session_state.score}</p>
            <div style="height:15px"></div>
            <p style="margin:0; font-size:14px; color:#8b949e;">CHUỖI LỬA</p>
            <p class="big-val streak-color" style="font-size: 80px !important; font-weight: 900 !important; color: #ff4b4b !important; margin: 0;">{st.session_state.streak} 🔥</p>
        </div>
...
<style>
    ...
    .check-box {{ 
        ...
        border: 1px solid #30363d; line-height: 1.7; font-size: {font_size}px !important;
    }}
...
with left:
    ...
    if st.session_state.current_data:
        ...
        for i, q in enumerate(st.session_state.current_data.get('questions', [])):
            ...
            # Kiểm tra xem câu này đã nộp chưa
